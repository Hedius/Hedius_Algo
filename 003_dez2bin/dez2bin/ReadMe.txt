========================================================================
    KONSOLENANWENDUNG: dez2bin-Projektübersicht
========================================================================

Diese dez2bin-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre dez2bin-Anwendung besteht.
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen dez2bin.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
