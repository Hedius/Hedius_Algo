========================================================================
    KONSOLENANWENDUNG: 009_structBSearch-Projektübersicht
========================================================================

Diese 009_structBSearch-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre 009_structBSearch-Anwendung besteht.


009_structBSearch.vcxproj
...
009_structBSearch.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen 009_structBSearch.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
