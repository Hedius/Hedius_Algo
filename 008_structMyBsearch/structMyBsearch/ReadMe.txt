========================================================================
    KONSOLENANWENDUNG: structMyBsearch-Projektübersicht
========================================================================

Diese structMyBsearch-Anwendung wurde vom Anwendungs-Assistenten für Sie erstellt.

Diese Datei bietet eine Übersicht über den Inhalt der einzelnen Dateien, aus
denen Ihre structMyBsearch-Anwendung besteht.


structMyBsearch.vcxproj
...
structMyBsearch.vcxproj.filters
...
StdAfx.h, StdAfx.cpp
    Mit diesen Dateien werden eine vorkompilierte Headerdatei (PCH) mit dem Namen structMyBsearch.pch und eine vorkompilierte Typendatei mit dem Namen StdAfx.obj erstellt.
